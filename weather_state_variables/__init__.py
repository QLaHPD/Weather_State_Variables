...
_LAZY_IMPORTS = {
    ...
    "LatentDynamicsConfig": (_MODELS_MODULE, "LatentDynamicsConfig"),
    "NeuralLatentDynamics": (_MODELS_MODULE, "NeuralLatentDynamics"),
    ...
    "LatentDynamicsTrainingConfig": (_TRAINING_MODULE, "LatentDynamicsTrainingConfig"),
    ...
    "run_latent_dynamics_smoke_test": (_TRAINING_MODULE, "run_latent_dynamics_smoke_test"),
    ...
    "train_latent_dynamics_model": (_TRAINING_MODULE, "train_latent_dynamics_model"),
